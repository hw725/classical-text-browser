...
class OcrPipeline:
    ...
    def prepare_page(
        ...
        current_rotation = page_rotation(
            Path(self.library_root) / "documents" / doc_id, part_id, page_number
        )
        ...
        if image_path is not None:
            ...
            page_image = rotate_page_image(
                ...
                page_rotation(Path(self.library_root) / "documents" / doc_id, part_id, page_number),
            )
        else:
            # PDF에서 페이지 추출 시도
