...
아키텍처:
    ...
    실제 API 엔드포인트 214개가 app/routers/ 패키지의 9개 모듈에 분산된다
    (2026-09-05 실측):
    ...
    routers/composition.py   — 편성: 내용 트리·경계·제안·목차·자동 트리·쪼개기·리셋 (12 라우트)
    ...
    routers/library.py       — 서고·설정·백업·휴지통·검증·연결·업데이트·엔진·로그인 (28 라우트)
