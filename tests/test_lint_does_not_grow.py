...
## 기준선은 비어 있다 — 2026-09-22에 64건을 다 갚았다
...
마지막 줄이 요점이다. `tests/test_structure_jev.py`의 긴 줄은 화면 JS에 넘기는
...
놓인다. ruff는 여러 줄 문자열의 진단을 **닫는 따옴표 줄로 옮겨** 보므로, 닫는 줄에
붙이면 그 문자열 하나만 면제된다(교차검토 지적, 실측 확인). 지금은 그렇게 되어 있다.

접는 일에도 함정이 둘 있었다(둘 다 2026-09-22 실측):

* ruff는 글자 수가 아니라 **표시 폭**으로 잰다. 한자·한글은 2칸이다.
...
# 기준선. **내려도 되고 올리면 안 된다.**
# 2026-09-22에 64건을 다 갚아 비었다 — 비어 있으면 「어느 파일이든 0」이다.
