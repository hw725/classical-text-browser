...
화면이 쓰임에 맞게 달라집니다 — 아래 두 그림의 **오른쪽 세로 탭 줄**을 비교해 보세요.
...
*교감 모드에서는 작업 탭이 **10개**입니다 — 오른쪽 세로 줄에 열람·레이아웃·교정·편성·
표점·현토·번역·주석·인용·이체자. 활성 탭을 다시 누르면 오른쪽 패널이 접힙니다.*
...
문헌만 고르면 되고, 해석 저장소는 표점 탭부터 씁니다(v1.3).
