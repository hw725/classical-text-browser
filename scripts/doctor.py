...
# doctor.bat 도 가상환경이 둘 다 없으면 시스템 파이썬으로 부른다 — 설치가 중간에
# 깨진 사람이 진단을 부르는 바로 그 상황이다. src 를 등록하기 전에 core 를 import
# 하면 그 사람은 진단 보고서 대신 ModuleNotFoundError 를 받는다(Codex 지적 2026-09-22).
...
# 여전히 **첫 출력보다는 앞**이다 — 그것이 E3 가 요구하는 것이다.
