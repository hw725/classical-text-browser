...
> | 2 · 8 | 라우트 183개 · JS 모듈 29개 · API 캐시 금지 미들웨어 |
...
프론트엔드(29개 JS 모듈) · 백엔드(FastAPI + 8 라우터, 라우트 183개) ·
...
flowchart TB
    ...
    subgraph BE["백엔드 (Python · FastAPI)"]
        ...
        subgraph ROUTERS["8개 도메인 라우터 (라우트 183개)"]
            direction LR
            R1["library <b>16</b>"]
            R2["documents <b>40</b>"]
...
flowchart TB
    subgraph APP["src/app/ -- API 레이어"]
        ...
        subgraph ROUTERS["routers/ -- 8개 도메인 · 라우트 183개"]
            direction LR
            R1["library <b>16</b>"]
            R2["documents <b>40</b>"]
            R3["interpretations <b>25</b>"]
