...
> | 2 · 8 | 라우트 219개 · JS 모듈 32개 · API 캐시 금지 미들웨어 |
...
프론트엔드(32개 JS 모듈) · 백엔드(FastAPI + 9 라우터, 라우트 219개) ·
...
flowchart TB
    ...
    subgraph BE["백엔드 (Python · FastAPI)"]
        ...
        subgraph ROUTERS["9개 도메인 라우터 (라우트 219개)"]
            direction LR
            R1["library <b>29</b>"]
            R2["documents <b>43</b>"]
...
flowchart TB
    subgraph APP["src/app/ -- API 레이어"]
        ...
        subgraph ROUTERS["routers/ -- 9개 도메인 · 라우트 219개"]
            direction LR
            R1["library <b>29</b>"]
            R2["documents <b>43</b>"]
            R3["interpretations <b>22</b>"]
