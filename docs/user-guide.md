...
1. 사이드바 **「내용」 ▸ 「자동 트리」**. 이 책의 확정본에서 되풀이되는 표지를 스스로 찾아
   ...
   - **③ 후보 고르기** — 체크 = 경계가 될 것. **행을 누르면 고르고, Shift로 범위, Ctrl로 하나씩** 골라
     위 줄에서 **역할·깊이를 한꺼번에** 바꿉니다(「바꾸기」). 「☑ 경계로」·「☐ 경계에서 빼기」·「억제」도 고른 행 전부에 듭니다.
     ①②③은 머리를 누르면 접히고, 접은 것은 이 브라우저가 기억합니다(①을 접어도 «찾은 규약» 한 줄은 남습니다).
     체크와 «고른 행»은 다른 것입니다 — 체크는 «경계가 될 것», 파랗게 고른 행은 «지금 한꺼번에 바꿀 것»이고, ③ 머리에
     그 한 줄이 늘 보입니다. 목차에는 있으나 본문에서 못 찾은 제목은 ③ 위에 노랗게 뜹니다 — 제목을 누르면 비슷한
