...
> 표시됩니다 — ▲▼로 옮겨 주세요.
>
> 쪽·행·글자를 세지 않아도 됩니다. **「찍기」를 켜고 원본 이미지나 교정 텍스트에서 자리를 누르면** 그
> 자리의 쪽·행·글자가 채워지고, 붉은 점선과 그 자리의 글자 여덟 자가 보입니다. 맞으면 ＋를 누르세요. 글자 번호는
> 행 길이로 어림한 것이라 협주가 섞인 행에서는 한두 자 어긋날 수 있어, 넣기 전에 확인하게 되어 있습니다.
>
