...
> **정본은 [../platform-v7.md](../platform-v7.md)입니다.** 내용이 다르면 정본이 맞습니다.
...
<div style="display: grid; grid-template-columns: 1.2fr 1fr 1fr 0.1fr; gap: 6px; align-items: center; margin-bottom: 6px;">
<div class="arch-box">국립공문서관 HTML/IIIF</div>
<div class="arch-box">archives_fetcher</div>
<div class="arch-box">archives_mapper</div>
<div class="parser-arrow">→</div>
</div>
<div style="display: grid; grid-template-columns: 1.2fr 1fr 1fr 0.1fr; gap: 6px; align-items: center; margin-bottom: 6px;">
<div class="arch-box">KOSTMA 뷰어</div>
<div class="arch-box">kostma_fetcher</div>
<div class="arch-box">kostma_mapper</div>
<div class="parser-arrow">→</div>
</div>
<div style="display: grid; grid-template-columns: 1.2fr 1fr 1fr 0.1fr; gap: 6px; align-items: center; margin-bottom: 6px;">
<div class="arch-box">장서각 dir/view</div>
<div class="arch-box">jsg_fetcher</div>
<div class="arch-box">jsg_mapper</div>
<div class="parser-arrow">→</div>
</div>
<div style="display: grid; grid-template-columns: 1.2fr 1fr 1fr 0.1fr; gap: 6px; align-items: center; margin-bottom: 6px;">
<div class="arch-box">규장각 book/view</div>
<div class="arch-box">kyujanggak_fetcher</div>
<div class="arch-box">kyujanggak_mapper</div>
<div class="parser-arrow">→</div>
</div>
<div style="display: grid; grid-template-columns: 1.2fr 1fr 1fr 0.1fr; gap: 6px; align-items: center; margin-bottom: 6px;">
...
- 구현된 파서: KORCIS, NDL Search, 일본 국립공문서관(IIIF 지원), KOSTMA, 장서각, 규장각, **범용 LLM 파서** (D-021, D-045)
- 범용 LLM 파서: markdown.new + LLM으로 모든 URL 지원
- 에셋 자동 감지 + 다운로드 (PDF/이미지 번들) — 6개 전용 파서에서 PDF 자동 다운로드 지원
...
**M4.1 서지정보 소스 추가** ✓ 전용 파서 7개(NDL, KORCIS, 국립공문서관, KOSTMA, 장서각, 규장각, 범용 LLM) — D-045
...
2. ~~서지정보 파싱 상세~~ → 완료 (7개 파서: NDL, KORCIS, 국립공문서관, KOSTMA, 장서각, 규장각, 범용 LLM)
...
6. ~~LLM 호출 아키텍처~~ → 완료 (D-010, 4단 폴백: Ollama→Gemini→OpenAI→Anthropic)
