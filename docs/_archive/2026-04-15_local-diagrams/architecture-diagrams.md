...
> **정본은 [../architecture-diagrams.md](../architecture-diagrams.md)입니다.** 내용이 다르면 정본이 맞습니다.
...
<div class="arch-box" style="margin: 3px 0;">1. Ollama (gemma4:e4b)</div>
<div class="arch-box" style="margin: 3px 0;">2. Gemini</div>
<div class="arch-box" style="margin: 3px 0;">3. OpenAI</div>
<div class="arch-box" style="margin: 3px 0;">4. Anthropic</div>
</div>
<div style="padding: 6px;">
...
<div class="arch-box" style="margin: 3px 0;">서지 파서<br/>(NDL · KORCIS · Archives.JP · KOSTMA · 장서각 · 규장각)</div>
</div>
</div>
</div>
</div>
...
<div class="arch-sidebar-item">NDL · KORCIS · KOSTMA<br/>장서각 · 규장각<br/>(서지 + 이미지)</div>
</div>
</div>
</div>
</div>
...
<div class="arch-title">LLM 5단 폴백 아키텍처</div>
<div class="arch-wrapper">
<div class="arch-main">
<div class="arch-layer application">
...
<div class="arch-layer-title" style="color: #5b21b6;">1순위: Ollama (로컬)</div>
<div class="arch-box" style="max-width: 400px; margin: 0 auto;">localhost:11434 — gemma4:e4b (멀티모달) · 무료 · 오프라인 가능</div>
</div>
<div style="text-align: center; font-size: 11px; color: #78350f;">↓ 실패 시</div>
<div class="arch-layer" style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border: 2px solid #059669;">
<div class="arch-layer-title" style="color: #065f46;">2순위: Gemini (Google AI)</div>
<div class="arch-box" style="max-width: 400px; margin: 0 auto;">GOOGLE_API_KEY · 저렴 · 비전 포함</div>
</div>
<div style="text-align: center; font-size: 11px; color: #78350f;">↓ 실�� 시</div>
<div class="arch-layer" style="background: linear-gradient(135deg, #ffedd5 0%, #fdba74 100%); border: 2px solid #ea580c;">
<div class="arch-layer-title" style="color: #9a3412;">3순위: OpenAI</div>
<div class="arch-box" style="max-width: 400px; margin: 0 auto;">OPENAI_API_KEY · 중간 비용 · 비전 포함</div>
</div>
<div style="text-align: center; font-size: 11px; color: #78350f;">↓ 실패 시</div>
<div class="arch-layer ai">
<div class="arch-layer-title">4순위: Anthropic (Claude)</div>
<div class="arch-box" style="max-width: 400px; margin: 0 auto;">ANTHROPIC_API_KEY · 최후 폴백</div>
</div>
...
<div class="arch-box">서지정보 파싱<br/>NDL · KORCIS · Archives.JP · KOSTMA · 장서각 · 규장각</div>
</div>
</div>
...
<style scoped>
.sr7-title { text-align: center; font-size: 22px; font-weight: bold; color: #78350f; margin-bottom: 16px; }
.sr7-group { padding: 14px; border-radius: 8px; margin: 0; box-shadow: 0 2px 6px rgba(120,53,15,0.08); }
.sr7-group-title { font-size: 13px; font-weight: bold; margin-bottom: 10px; text-align: center; }
.sr7-grid { display: grid; gap: 6px; }
.sr7-g2 { grid-template-columns: repeat(2, 1fr); }
.sr7-g3 { grid-template-columns: repeat(3, 1fr); }
.sr7-g5 { grid-template-columns: repeat(5, 1fr); }
.sr7-box { border-radius: 5px; padding: 7px 6px; text-align: center; font-size: 11px; font-weight: 600; line-height: 1.3; color: #44220e; background: #fffcf7; border: 1px solid #d4c4a8; }
.sr7-box.key { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 2px solid #b45309; }
.sr7-ref { display: flex; align-items: center; gap: 6px; padding: 3px 8px; font-size: 10px; color: #78350f; line-height: 1.3; }
.sr7-ref-arrow { font-size: 14px; font-weight: bold; flex-shrink: 0; }
.sr7-ref b { font-weight: 700; }
/* 커넥터: 그룹 간 화살표 행 */
.sr7-conn { display: flex; flex-direction: column; align-items: center; padding: 6px 0; gap: 3px; }
.sr7-conn-arrow { font-size: 20px; font-weight: bold; line-height: 1; }
.sr7-conn-label { font-size: 11px; font-weight: 600; line-height: 1.3; text-align: center; max-width: 600px; }
/* 그룹 색상 */
.sr7-src { background: linear-gradient(135deg, #ffedd5 0%, #fdba74 100%); border: 2px solid #ea580c; }
.sr7-src .sr7-group-title { color: #9a3412; }
.sr7-int { background: linear-gradient(135deg, #e0e7ff 0%, #c7d2fe 100%); border: 2px solid #4f46e5; }
.sr7-int .sr7-group-title { color: #3730a3; }
.sr7-core { background: linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 100%); border: 2px solid #7c3aed; }
.sr7-core .sr7-group-title { color: #5b21b6; }
.sr7-exch { background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border: 2px solid #059669; }
.sr7-exch .sr7-group-title { color: #065f46; }
</style>

<div class="sr7-title">스키마 간 참조 관계도</div>

<!-- ━━ 원본 저장소 ━━ -->
<div class="sr7-group sr7-src">
<div class="sr7-group-title">원본 저장소 스키마 (7개)</div>
<div class="sr7-grid sr7-g3" style="margin-bottom: 6px;">
<div class="sr7-box key">manifest<br/><i style="font-size:9px;">document_id, parts</i></div>
<div class="sr7-box">layout_page<br/><i style="font-size:9px;">LayoutBlock, bbox, reading_order</i></div>
<div class="sr7-box">ocr_page<br/><i style="font-size:9px;">OcrResult, char, confidence</i></div>
</div>
<div class="sr7-grid sr7-g2" style="margin-bottom: 8px;">
<div class="sr7-box">corrections<br/><i style="font-size:9px;">type, original_ocr, corrected</i></div>
<div class="sr7-box">bibliography<br/><i style="font-size:9px;">서지정보, raw_metadata</i></div>
</div>
<div style="border-top: 1px dashed #d4956a; padding-top: 6px; margin-top: 2px;">
<div style="font-size: 10px; font-weight: bold; color: #9a3412; margin-bottom: 4px;">내부 참조</div>
<div class="sr7-ref"><span class="sr7-ref-arrow" style="color:#b45309;">→</span> <b>layout_page · ocr_page</b> → <b>manifest</b> &nbsp;<i>(part_id)</i></div>
<div class="sr7-ref"><span class="sr7-ref-arrow" style="color:#b45309;">→</span> <b>ocr_page · corrections</b> → <b>layout_page</b> &nbsp;<i>(layout_block_id)</i></div>
</div>
</div>

<!-- ━━ 커넥터: 원본 ↔ 해석 ━━ -->
<div class="sr7-conn">
<div class="sr7-conn-arrow" style="color: #4f46e5;">▼</div>
<div class="sr7-conn-label" style="color: #3730a3;">
<b>interp_manifest · dependency</b> → manifest <i>(document_id + base_commit)</i><br/>
<b>모든 해석 스키마 (5개)</b> → layout_page <i>(block_id)</i>
</div>
<div class="sr7-conn-arrow" style="color: #4f46e5;">▼</div>
</div>

<!-- ━━ 해석 저장소 ━━ -->
<div class="sr7-group sr7-int">
<div class="sr7-group-title">해석 저장소 스키마 (5개)</div>
<div style="display: flex; gap: 6px; margin-bottom: 6px;">
<div style="flex: 1;">
<div class="sr7-grid sr7-g2" style="margin-bottom: 6px;">
<div class="sr7-box">interp_manifest<br/><i style="font-size:9px;">source_document_id</i></div>
<div class="sr7-box">dependency<br/><i style="font-size:9px;">base_commit, tracked_files</i></div>
</div>
<div class="sr7-grid sr7-g3">
<div class="sr7-box">punctuation_page<br/><i style="font-size:9px;">L5 표점</i></div>
<div class="sr7-box">hyeonto_page<br/><i style="font-size:9px;">L5 현토</i></div>
<div class="sr7-box">citation_mark_page<br/><i style="font-size:9px;">L7 인용마크</i></div>
</div>
</div>
<div style="width: 2px; background: #818cf8; flex-shrink: 0; border-radius: 1px;"></div>
<div style="display: flex; flex-direction: column; gap: 6px; width: 220px; flex-shrink: 0;">
<div class="sr7-box key" style="border-color: #4f46e5;">translation_page<br/><i style="font-size:9px;">L6 번역 + annotation_context</i></div>
<div style="text-align: center; font-size: 14px; font-weight: bold; color: #4f46e5; line-height: 1;">↕</div>
<div class="sr7-box key" style="border-color: #4f46e5;">annotation_page v2<br/><i style="font-size:9px;">L7 주석 + 사전형 + 4단계 이력</i></div>
<div style="text-align: center; font-size: 9px; color: #3730a3;">annotation_context (양방향)</div>
</div>
</div>
</div>

<!-- ━━ 커넥터: 해석 → 코어 (없음, 독립) / 코어 → 원본 ━━ -->
<div class="sr7-conn">
<div class="sr7-conn-arrow" style="color: #7c3aed;">▼</div>
<div class="sr7-conn-label" style="color: #5b21b6;">
<b>TextBlock</b> → manifest <i>(source_ref: document_id + page + block_id + commit)</i>
</div>
<div class="sr7-conn-arrow" style="color: #7c3aed;">▼</div>
</div>

<!-- ━━ 코어 스키마 ━━ -->
<div class="sr7-group sr7-core">
<div class="sr7-group-title">코어 스키마 (6개) — 해석 저장소 내부</div>
<div style="display: flex; gap: 10px; align-items: flex-start;">
<!-- 왼쪽: Work ← TextBlock ← Tag ⇢ Concept -->
<div style="flex: 1;">
<div style="display: flex; align-items: center; gap: 6px; margin-bottom: 4px;">
<div class="sr7-box" style="flex: 1;">Work<br/><i style="font-size:9px;">title, author, period</i></div>
<div style="font-size: 13px; font-weight: bold; color: #7c3aed; flex-shrink: 0;">←<br/><i style="font-size:8px;">work_id</i></div>
<div class="sr7-box key" style="flex: 1.2;">TextBlock<br/><i style="font-size:9px;">original_text, source_ref</i></div>
<div style="font-size: 13px; font-weight: bold; color: #7c3aed; flex-shrink: 0;">←<br/><i style="font-size:8px;">block_id</i></div>
<div class="sr7-box" style="flex: 1;">Tag<br/><i style="font-size:9px;">surface, core_category</i></div>
</div>
<div style="display: flex; align-items: center; gap: 6px;">
<div style="flex: 1;"></div>
<div style="flex: 1.2;"></div>
<div style="display: flex; align-items: center; gap: 4px; flex: 1; justify-content: center;">
<span style="font-size: 13px; font-weight: bold; color: #059669;">⇣</span>
<span style="font-size: 9px; color: #059669; font-weight: 600;">승격</span>
</div>
</div>
<div style="display: flex; align-items: center; gap: 6px;">
<div style="flex: 1;"></div>
<div style="flex: 1.2;"></div>
<div class="sr7-box" style="flex: 1;">Concept<br/><i style="font-size:9px;">label, concept_features</i></div>
</div>
</div>
<!-- 구분선 -->
<div style="width: 2px; background: #a78bfa; flex-shrink: 0; border-radius: 1px; align-self: stretch;"></div>
<!-- 오른쪽: Agent, Relation -->
<div style="width: 180px; flex-shrink: 0;">
<div class="sr7-box" style="margin-bottom: 6px;">Agent<br/><i style="font-size:9px;">name, period</i></div>
<div class="sr7-box">Relation<br/><i style="font-size:9px;">subject, predicate, object</i></div>
<div style="margin-top: 6px; font-size: 9px; color: #5b21b6; line-height: 1.4;">
<b>Relation →</b> Agent/Concept <i>(subject_id, object_id)</i><br/>
<b>Relation →</b> TextBlock <i>(evidence_blocks)</i>
</div>
</div>
</div>
</div>
...
<div class="sr7-group sr7-exch" style="padding: 10px;">
<div class="sr7-group-title">교환 형식 (1개)</div>
<div class="sr7-box key" style="max-width: 400px; margin: 0 auto; border-color: #059669;">exchange — 단일 JSON 스냅샷 · 원본+해석 전체 직렬화 · 내보내기/가져오기</div>
</div>
</div>

<!-- ━━ 범례 ━━ -->
<div style="margin-top: 10px; text-align: center; font-size: 11px; color: #78350f; padding: 6px; background: #f5efe6; border-radius: 6px;">
<span style="font-size: 14px; color: #b45309; font-weight: bold;">→</span> 참조 &nbsp;&nbsp;
<span style="font-size: 14px; color: #b45309; font-weight: bold;">↔</span> 양방향 &nbsp;&nbsp;
<span style="font-size: 14px; color: #059669; font-weight: bold;">⇣</span> 승격(promote) &nbsp;&nbsp;
<span style="display: inline-block; width: 8px; height: 8px; background: linear-gradient(135deg, #fef3c7, #fde68a); border: 1.5px solid #b45309; border-radius: 2px; vertical-align: middle;"></span> 핵심 스키마
</div>
...
<div class="arch-box tech" style="margin: 3px 0;">ollama (gemma4:e4b)</div>
...
<div class="arch-box" style="margin: 3px 0;">src/parsers/<br/>ndl, korcis, archives_jp, kostma, jsg, kyujanggak</div>
